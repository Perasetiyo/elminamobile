<?php foreach ($liabilities as $item): ?>	
	...
	<div class="pagetitle">
		<h1>&nbsp;Edit Money Repaid <?=$item->liabilities_desc?></h1>
	</div>
</div><!--pageheader-->
            ...
            <div class="maincontentinner">
				...
				<div class="span8">
					<div class="widgetbox personal-information">
						...
						<form id="addliabilities" name="addliabilities" class="stdform" method="post" action="<?=base_url()?>index.php/liabilities/doUpdateRepaid/" />
