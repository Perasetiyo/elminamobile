			...
			<div class="maincontentinner">
				...
				<form method="post" action="<?=base_url()?>index.php/ppe/search">
					...
					<div style="float:left">
						...
						<a href="<?=base_url()?>index.php/depreciation/lists" class="btn btn-warning" style = "color:#fff;"></span>Depreciation</a>
					</div>
					<?php echo $links; ?>
                ...
                <table width="100%" class="table table-bordered" id="dyntable">
                    ...
                    <tbody>
                        ...
                        <tr class="gradeX">
                            ...
                            <td>
								<font <?php if ($item->ppe_status == 0) echo 'style="color:grey;"';?>>
									<?=$item->ppe_desc?>
								</font>
							</td>
                            ...
                            <td class="centeralign">
								...
								<?php if ($item->ppe_status != 0) {?>
									<a href="<?=base_url()?>index.php/ppe/jual/<?=$item->ppe_id?>" title="Dijual"><span class="iconsweets-money"></span></a>&nbsp;
								<?php } ?>	
							</td>
                        </tr>
                        <?php endforeach; 
