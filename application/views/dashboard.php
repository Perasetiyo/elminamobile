    ...
    <div class="leftpanel">
        ...
        <div class="leftmenu">        
			...
			<li class="nav-header">Operation</li>
				...
				<li><a href="<?=base_url()?>index.php/agent/lists"><span class="iconfa-laptop"></span>Partners List</a></li>
				<li><a href="<?=base_url()?>index.php/wallet/users"><span class="iconfa-laptop"></span>Wallet Users</a></li>
			<?php } ?>	
			...
			<li class="nav-header">General Tools</li>
				<li><a href="<?=base_url()?>index.php/options/lists"><span class="iconfa-laptop"></span>Options</a></li>
			...
			<li class="nav-header">Accounting</li>
				...
				<li><a href="<?=base_url()?>index.php/income/main"><span class="iconfa-laptop"></span>Earnings</a></li>
			
				<li><a><h3><strong>COST</strong></h3></a></li>
				<li><a href="<?=base_url()?>index.php/expense/lists"><span class="iconfa-laptop"></span>General Expenses</a></li>
				<li><a href="<?=base_url()?>index.php/production_cost/lists"><span class="iconfa-laptop"></span>Manufacturing Cost</a></li>
			...
			<?php if ($session_data['user_role'] == 'admin' || $session_data['user_role'] == 'member') { ?>
			<li class="nav-header">Member Area</li>
				<li><a href="<?=base_url()?>index.php/order"><span class="iconfa-laptop"></span>Order</a></li>
				<li><a href="http://stok.elmina-id.com/"><span class="iconfa-laptop"></span>Cek Stok</a></li>
				<li><a href="<?=base_url()?>index.php/catalogue/main"><span class="iconfa-laptop"></span>Katalog</a></li>
				<li><a href="<?=base_url()?>index.php/Incubator/main"><span class="iconfa-laptop"></span>Elmina Incubator</a></li>
